...
export default function Hero() {
  return (
 <> <Helmet>
    <title>Rohit Bhojwani Portfolio</title>
...
<div id="sticky-banner" tabindex="-1" class="openForRole z-50 rounded-full mx-2 flex justify-between w-max p-2 md:p-4 border bg-[#271464]" style={{ boxShadow:
    ...
    <div class="flex items-center mx-auto">
        <p class="flex items-center text-sm font-normal text-white">
            ...
            <span>Actively looking for <p class="inline font-medium  underline text-blue-300 underline-offset-2 decoration-600 dark:decoration-500 decoration-solid hover:no-underline hover:cursor-pointer">Software Development Engineer</p> role. </span>
        </p>
    </div>
</div>
</div>
