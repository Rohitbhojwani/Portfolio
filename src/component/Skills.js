...
import {SiTailwindcss,SiNetlify,SiMysql,SiNotion,SiWordpress,SiJava,SiMaterialui,SiDjango,SiFirebase,SiPycharm} from 'react-icons/si'
...
export default function Skills() {
  ...
  <div className="icons my-20 grid grid-cols-2 md:grid-cols-6 gap-10 py-20 place-items-center">
    <CgCPlusPlus color='white' size='72' className='icon'/>
    <DiPython color='white' size='72' className='icon'/>
    <DiJava color='white' size='72' className='icon'/>
    ...
    <SiDjango color='white' size='72' className='icon'/>
    <SiMaterialui color='white' size='72' className='icon'/>
    <SiTailwindcss color='white' size='72' className='icon'/>
    <DiMongodb color='white' size='72' className='icon'/>
    <SiFirebase color='white' size='72' className='icon'/>
    {/* <SiPycharm color='white' size='72' className='icon'/> */}
